...
const DbDestination = [
    ...
    {id: 3, name: "Arizona", description:"", pic1: arizona, pic2: arizona2, key: []},
    {id: 4, name: "Equateur", description:"", pic1: ecuador, pic2: ecuador2, key: []},
    {id: 5, name: "Cuba", description:"", pic1:cuba , pic2:cuba2 , key: []},
    {id: 6, name: "Madrid", description:"", pic1: madrid, pic2: madrid2, key: []},
    {id: 7, name: "Rome", description:"", pic1: rome, pic2: rome2, key: []},
    {id: 8, name: "Hawaï", description:"", pic1: hawai, pic2: hawai2, key: []},
    {id: 9, name: "Hong-Kong", description:"", pic1: hongkong, pic2: hongkong2, key: []},
    {id: 10, name: "Le Cap", description:"", pic1: lecap, pic2: lecap2, key: []},
    {id: 11, name: "Cap d'Agde", description:"", pic1: capdagde, pic2: capdagde2, key: []},
    {id: 12, name: "Reykjavik", description:"", pic1: reykjavik, pic2: reykjavik2, key: []},
    {id: 13, name: "Marrakech", description:"", pic1: marrakech, pic2: marrakech2, key: []},
];
